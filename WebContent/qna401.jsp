...
var boardlist = <%=request.getAttribute("boardlist")%>;
...
<div class="container">
 ...
 <div class="mail-box" >
                  <aside class="sm-side">
                      <div class="user-head">
                          <a class="inbox-avatar" href="javascript:;" style = "color:#341a79;">
                      ...
                      <ul class="inbox-nav inbox-divider">
                          <li class="active">
                              <a href="#"><i class="fa fa-inbox"></i> Q&A <span class="label label-danger pull-right">2</span></a>

                          </li>
                          <li>
                              <a href="#"><i class="fa fa-bookmark-o"></i> Notice</a>
                          </li>
                      </ul>
                  ...
                  <aside class="lg-side">
                      ...
                      <div class="inbox-body">
                         <div class="mail-option">
                             ...
                             <div class="btn-group">
                                 <a href="boardWrite.jsp?bcode=401&tcode=0" class="btn mini blue">글쓰기</a>                                      		                                                                                                 
                             </div>
                          ...
                          <table class="table table-inbox table-hover">
                            ...
                            <tr class="unread">
                                  ...
                                  <td class="view-message dont-show">글쓴이 </td>
                                  <td class="view-message">제목</td>
                                  <td class="view-message inbox-small-cells"></td>
                                  <td class="view-message">작성일</td>
                                  <td class="view-message text-right">조회수</td>
                              </tr>

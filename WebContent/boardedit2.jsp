            ...
            <div class="row">
               ...
               <div class="col-md-8">
                     ...
                     <c:set var="board" value='${requestScope.boarddetail}'></c:set>
                        ...
                        <tr id="content2">
                           <td><h6>Content</h6></td>
                           <td><textarea rows="200" cols="100" name="content" id="content"  style="height:500px; overflow:visible;" >${board.content}</textarea></td>
                        </tr>
                    ...
                    <tr >
                        <!-- 202 : 후기파일 게시판  -->
                        <td><input type="hidden" id="bcode"  name="bcode" value='${board.bcode}'></td>
                        <!-- tcode : 0 거래없음 -->
                        <td>
                        <input type="hidden" id="tcode" type="text" name="tcode" value='${board.tcode}'>
                        <c:choose>
                        <c:when test="${board.idx != null }">
                        ...
                        <td colspan="2" align="center">
        				 ...
        				 <button type=submit  class="btn dorne-btn" style="width: 200px;" onclick="check();"  >
                                 <i class="far fa-check-circle"></i>&nbsp;&nbsp;수정완료
                              </button>
        				 ...
        				 <button type="submit" class="btn dorne-btn" onclick="mylist();">목록  </button>  
...
function mylist(){
	...
	document.location.href ='/CampingEasy/boardList.do?cp='+ ${board.cp}+'&ps='+ ${board.ps}+'&bcode='+${board.bcode}+'&zcode=0';
}
</script>
</html>
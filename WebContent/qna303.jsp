				...
				success :function(responsedata){
					...
					$.each(responsedata,function(index, obj){
                        ...
                        if(obj.cocode ==1){
                        	...
                        	mytable += "<td class='view-message  text-right'><a href='boardDetail.do?bcode="+ obj.bcode+"&edit=1&tcode=0&idx="+ obj.idx+ "&cp="+obj.cp+"&ps="+ obj.ps+"&zcode=0' class='btn mini blue'>수정</a> </td>";
                            mytable += "<td class='view-message  text-right'><a href='boardDelete.do?bcode="+ obj.bcode+"&tcode=0&idx="+ obj.idx + "&cp="+obj.cp+"&ps="+ obj.ps+"&zcode=0' class='btn mini blue' onclick='return confirm(message())'>삭제 </a> </td>";
                        }
					...
					<aside class="lg-side">
						...
						<div class="inbox-body">
							<div class="mail-option">
								...
								<div class="btn-group">
									<a
										href="gotoWrite.do?zcode=0&bcode=303&tcode=0&cp=${param.cp}&ps=${param.ps}&idx=0"
								...
								<tbody id="mytable">
									...
									&nbsp;&nbsp;&nbsp;
												...
												<c:choose>
													...
													<c:otherwise>
														<a href="boardDetail.do?edit=0&idx=${blist.idx}&bcode=${blist.bcode}&cp=${cp}&ps=${ps}&zcode=0">  ${blist.title}</a>
													</c:otherwise>
												</c:choose></td>
